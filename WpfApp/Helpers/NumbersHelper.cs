...
namespace WpfApp.Helpers
{
    ...
    "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
        ...
        public static double GetRoundOffValue(double originalVal)
        {
            double roudedVal = Math.Round(originalVal, MidpointRounding.AwayFromZero);
            double roundOffValue = 0;
            roundOffValue -= originalVal - roudedVal;
            return Math.Round(roundOffValue, 2);
        }
    }
}
